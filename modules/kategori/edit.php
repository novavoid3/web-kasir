...
<div class="d-flex">
    ...
    <div class="main-content">
        ...
        if(isset($_POST['update'])){
            ...
            mysqli_query($conn, "UPDATE kategori SET nama_kategori='$kategori' WHERE id_kategori='$id'");
        ...
        <div class="edit-card">
            ...
            <div class="edit-header">
                ...
                <h3 class="edit-title">Edit Kategori</h3>
                <p class="edit-subtitle">Perbarui nama kategori</p>
            </div>

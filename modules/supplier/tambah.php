...
if(isset($_POST['simpan'])){
    ...
    mysqli_query($conn, "INSERT INTO supplier VALUES (NULL, '$nama', '$telepon', '$alamat')");
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            ...
            <p class="page-subtitle">Tambah data supplier baru</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="alamat" class="form-control" rows="4" placeholder="Masukkan alamat supplier" required></textarea>
                </div>
            </div>
        </div>
